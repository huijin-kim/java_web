        ...
        <form action="empInsertOK.do" method="post">
            <table id="empTable">
                ...
                <tr>
                    ...
                    <td><input type="number" id="manager_id" name="manager_id" value="103" placeholder="manager_id"></td>
                </tr>
                <tr>
                    <td><label for="department_id">department_id:</label></td>
                    <td><input type="number" id="department_id" name="department_id" value="60" placeholder="department_id"></td>
                </tr>
